...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_carre" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#1eee1b5d#;
   pragma Export (C, u00001, "carreB");
   ...
   u00104 : constant Version_32 := 16#fd83e873#;
   pragma Export (C, u00104, "system__concat_2B");
   u00105 : constant Version_32 := 16#0afbb82b#;
   pragma Export (C, u00105, "system__concat_2S");
   u00106 : constant Version_32 := 16#eca5ecae#;
   pragma Export (C, u00106, "system__memoryB");
   u00107 : constant Version_32 := 16#512609cf#;
